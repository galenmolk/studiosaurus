...
namespace Studiosaurus
{
    public class AssetGallery<T> : ScriptableObject where T : GenericAsset<T>
    {
        ...
        public Sprite icon;
        public FileUploadButton.FileType fileType;
        public AssetSlot<T> selectedSlot;
        ...
        {
            assetSelector = Instantiate(assetSelectorPrefab);
            assetSelector.Open(this);
        }
