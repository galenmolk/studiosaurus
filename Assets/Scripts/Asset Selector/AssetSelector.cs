...
namespace Studiosaurus
{
    public class AssetSelector<T> : MonoBehaviour where T : GenericAsset<T>
    {
        ...
        protected AssetComponent<T> selectedAssetComponent;
        ...
        public void Open(AssetGallery<T> gallery)
        {
            this.gallery = gallery;
            FileUploadButton.fileType = gallery.fileType;
            CreateSlots();
        ...
        {
            if (gallery.selectedSlot != null && selectedAssetComponent != null)
                selectedAssetComponent.AssignAsset(gallery.selectedSlot.Asset);
        ...
        {
            deletionWindow.OpenWindow(fileSlot, this);
        }
