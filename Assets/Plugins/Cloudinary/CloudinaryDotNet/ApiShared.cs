...
namespace CloudinaryDotNet
{
    ...
    public partial class ApiShared : ISignProvider
    {
        ...
        // The below method, BuildUserAgent, has been modified from the original Cloudinary .NET SDK.
        // See GitHub Issue comment for more details:
        // https://github.com/cloudinary/CloudinaryDotNet/issues/278#issuecomment-864550108
        private static string BuildUserAgent()
        {
            string userAgentString = $"CloudinaryDotNet/{CloudinaryVersion.Full} ({RuntimeInformation.FrameworkDescription})";
            #if UNITY_EDITOR
            userAgentString += ")";
            #endif
            Debug.Log(userAgentString);
